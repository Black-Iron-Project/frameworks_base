...
package com.android.systemui.blackiron.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.blackiron.header.STATUS_BAR_HEADER_UPDATE";
