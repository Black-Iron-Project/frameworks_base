/*
 * Copyright (C) 2018-2024 BlackIron Project
...
package com.android.systemui.blackiron.logo;
...
public abstract class LogoImage extends ImageView implements DarkReceiver {
    ...
    public void updateLogo() {
        ...
        switch (mLogoStyle) {
            case 0:
            default:
                drawable = mContext.getResources().getDrawable(R.drawable.ic_blackiron_logo);
                break;
            case 1:
