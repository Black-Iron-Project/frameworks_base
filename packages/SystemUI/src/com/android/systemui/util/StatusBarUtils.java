...
public class StatusBarUtils {
    ...
    private StatusBarUtils(Context context) {
        ...
        int userLeftPadding = Settings.System.getInt(context.getContentResolver(), leftPaddingKey, -1);
        int userRightPadding = Settings.System.getInt(context.getContentResolver(), rightPaddingKey, -1);
        int userTopPadding = Settings.System.getInt(context.getContentResolver(), topPaddingKey, -1);
        
        mLeftPad = userLeftPadding == -1 ? getDefaultLeftPadding() : userLeftPadding;
        mRightPad = userRightPadding == -1 ? getDefaultRightPadding() : userRightPadding;
        mTopPad = userTopPadding == -1 ? getDefaultTopPadding() : userTopPadding;

        Settings.System.putInt(context.getContentResolver(), leftPaddingKey + DEFAULT, getDefaultLeftPadding());
        Settings.System.putInt(context.getContentResolver(), rightPaddingKey + DEFAULT, getDefaultRightPadding());
        Settings.System.putInt(context.getContentResolver(), topPaddingKey + DEFAULT, getDefaultTopPadding());
    }
    ...
    public int getDefaultLeftPadding() {
        return mRes.getDimensionPixelSize(R.dimen.status_bar_padding_start);
    }

    public int getDefaultRightPadding() {
        return mRes.getDimensionPixelSize(R.dimen.status_bar_padding_end);
    }

    public int getDefaultTopPadding() {
        return mRes.getDimensionPixelSize(R.dimen.status_bar_padding_top);
    }
