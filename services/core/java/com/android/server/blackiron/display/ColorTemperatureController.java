 ...
 */
package com.android.server.blackiron.display;
...
import com.android.server.blackiron.display.TwilightTracker.TwilightState;

import java.io.PrintWriter;
import java.util.BitSet;

import com.android.internal.blackiron.hardware.LineageHardwareManager;
import com.android.internal.blackiron.hardware.LiveDisplayManager;
import com.android.internal.util.blackiron.ColorUtils;

import static com.android.internal.blackiron.hardware.LiveDisplayManager.MODE_AUTO;
import static com.android.internal.blackiron.hardware.LiveDisplayManager.MODE_DAY;
import static com.android.internal.blackiron.hardware.LiveDisplayManager.MODE_NIGHT;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mColorBalanceCurve = com.android.internal.util.blackiron.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.android.internal.util.blackiron.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
