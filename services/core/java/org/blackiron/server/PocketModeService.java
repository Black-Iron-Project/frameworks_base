...
public class PocketModeService extends SystemService {
    ...
    public static final String ACTION_POCKET_STATE_CHANGED = "org.blackiron.server.action.POCKET_STATE_CHANGED";
    ...
    public void onStart() {
        ...
        IntentFilter filter = new IntentFilter("org.blackiron.server.action.AOD_STATE_CHANGED");
